...
import { Star, Flame, Clock, Leaf, Plus, Sparkles } from "lucide-react";
...
export default function ProductCard({ item, onCustomize }: ProductCardProps) {
  ...
  return (
    <motion.div
      ...
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      className="group relative bg-[var(--yume-warm-white)] border border-[var(--yume-cream)] hover:shadow-xl transition-all duration-300 overflow-hidden"
    >
